...
public class BlockArray // 나중에 블럭프리펩 다 넣었을때를 위해 미리작성해둔 코드들, 프리펩에 따라 gameobject로 일괄변경
{

    private GameObject[,] grid; // 블록의 색상을 저장하는 2차원 배열
    ...
    public BlockArray()
    {
        // 10x20 크기의 그리드를 생성하고 모든 위치를 일단 비어있는 상태로 초기화
