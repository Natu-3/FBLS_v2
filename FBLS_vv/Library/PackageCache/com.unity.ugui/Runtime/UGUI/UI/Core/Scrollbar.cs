    ...
    public class Scrollbar : Selectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        protected IEnumerator ClickRepeat(Vector2 screenPosition, Camera camera)
        {
            while (isPointerDownAndNotDragging)
            {
                ...
                {
<<<<<<< Updated upstream:FBLS_vv/Library/PackageCache/com.unity.ugui@1.0.0/Runtime/UI/Core/Scrollbar.cs
                    Vector2 localMousePos;
...
>>>>>>> Stashed changes:FBLS_vv/Library/PackageCache/com.unity.ugui/Runtime/UGUI/UI/Core/Scrollbar.cs
                }
